...
<div id="my_works" class='edit_form'><br><br><br>
    <table class='table_1'>
     ...
     <br><br><br>
    <table class='table_2'><tr><td><center>  <button class="ok_btn">موافق</button> </center> </td>
        <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
         <td> <center> <button id="close_edit_btn" class="close_btn_2">إلغاء</button> </center> </td>
</tr>
</table>
...
<table>
    ...
    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><button class="ok_btn" id="upload_work_file">  حفظ   </button> </td>
        <td></td>
...
<table>
    ...
    <td><button id="close_edit_btn"  class="close_btn_2" onclick="close_form()">إلغاء</button></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><button class="ok_btn" id="add_youtube_link">  حفظ   </button> </td>
        <td></td>
